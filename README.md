# AIProjCourse — лендинг

Публичный лендинг курса «Управление проектом через репозиторий: Cursor + GitHub».

- **Сайт:** https://yykuzmenkov.github.io/CursorProjCoursePages/
- **Стек:** статический HTML + CSS, без JS и сборщиков; шрифты — Google Fonts (IBM Plex Sans / Mono).
